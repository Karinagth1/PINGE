...
import 'package:best_flutter_ui_templates/fitness_app/my_diary/granu.dart';
...
class GranuladosScreen extends StatefulWidget {
  const GranuladosScreen({Key? key, this.animationController})
      : super(key: key);

  final AnimationController? animationController;
  @override
  _GranuladosScreenState createState() => _GranuladosScreenState();
}

class _GranuladosScreenState extends State<GranuladosScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Materiales granulados',
        subTxt: 'Customize',
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
            curve:
                          ...
                          children: <Widget>[
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  'Materiales granulados y agregados',
