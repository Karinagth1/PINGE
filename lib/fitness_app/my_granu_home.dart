...
class MyGranuHome extends StatefulWidget {
  @override
  _MyGranuHomeState createState() => _MyGranuHomeState();
}

class _MyGranuHomeState extends State<MyGranuHome>
  ...
  void initState() {
    ...
    tabBody = GranuladosScreen(animationController: animationController);
